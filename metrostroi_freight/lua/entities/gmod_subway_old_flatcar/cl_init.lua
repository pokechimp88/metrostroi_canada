...
ENT.ClientProps["FrontBrake"] = {
    ...
    pos = Vector(323+225, -30+0.5, -69+65),
    ang = Angle( 15,-90,0),
    hide = 2,30
}
...
function ENT:UpdateWagonNumber()
    ...
    for i=0,5 do
        ...
        if IsValid(leftNum) then
            leftNum:SetPos(self:LocalToWorld(Vector(220+i*6.6-count*6.6/2,54.1,7)))
            leftNum:SetSkin(num)
        end
        if IsValid(rightNum) then
            rightNum:SetPos(self:LocalToWorld(Vector(-220-i*6.6+count*6.6/2,-54.1,7)))
