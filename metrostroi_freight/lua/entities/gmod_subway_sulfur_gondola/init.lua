...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/openhoppers/gon_transcona_sulfur.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(200,0,-20),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-200,0,-20),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 290,0,-77+75),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-290,0,-77+75),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 290,0,-79+75),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-290,0,-79+75),Angle(0,180,0),false,"717")
    end
