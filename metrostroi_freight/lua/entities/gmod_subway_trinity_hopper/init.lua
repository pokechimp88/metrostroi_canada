...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/hoppers/hopper_trin_5161.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(230,0,-22),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-230,0,-22),Angle(0,0,0),false,"702")
