...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/boxcars/boxcar_50ft_pcf_insulated.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(190,0,-23),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-190,0,-23),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 295,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-295,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 295,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-295,0,-79+70),Angle(0,180,0),false,"717")
    end
