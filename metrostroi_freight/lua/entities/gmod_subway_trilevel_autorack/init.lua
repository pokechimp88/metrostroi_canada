...
function ENT:Initialize()
    ...
    self:SetModel("models/gsgtrainprops/trains/rolling_stock/autorack_trilevel_semiopen.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(400,0,-23),Angle(0,180,0),true,"702")
