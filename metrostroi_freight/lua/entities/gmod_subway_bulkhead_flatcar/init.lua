...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/flatcars/thrall_bulkheadflat.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(290,0,-13),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-290,0,-13),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 375,0,-77+80),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-375,0,-77+80),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 375,0,-79+80),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-375,0,-79+80),Angle(0,180,0),false,"717")
    end
    ...
    self.InteractionZones = {
        {
            ...
            Pos = Vector(410, -30, 0), Radius = 20,
        },
        {
            ID = "FrontTrainLineIsolationToggle",
            Pos = Vector(410, 31, 0), Radius = 20,
        },
        {
            ID = "RearTrainLineIsolationToggle",
            Pos = Vector(-410, -30, 5), Radius = 20,
        },
        {
            ID = "RearBrakeLineIsolationToggle",
            Pos = Vector(-410, 31, 5), Radius = 20,
        },
    }
