...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/centerbeams/nsc_centerbeam.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(320,0,-23),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-320,0,-23),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 425,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-425,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 425,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-425,0,-79+70),Angle(0,180,0),false,"717")
    end
    ...
    self.InteractionZones = {
        {
            ...
            Pos = Vector(450, -30, 0), Radius = 20,
        },
        {
            ID = "FrontTrainLineIsolationToggle",
            Pos = Vector(450, 31, 0), Radius = 20,
        },
        {
            ID = "RearTrainLineIsolationToggle",
            Pos = Vector(-450, -30, 5), Radius = 20,
        },
        {
            ID = "RearBrakeLineIsolationToggle",
            Pos = Vector(-450, 31, 5), Radius = 20,
        },
    }
