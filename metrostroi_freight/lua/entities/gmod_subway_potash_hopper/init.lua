...
ENT.BogeyDistance = 460 -- Needed for gm trainspawner
ENT.SyncTable = {
...
function ENT:Initialize()
    ...
    self:SetModel("models/gsgtrainprops/trains/rolling_stock/hopper_covered_potash_4550.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(230,0,-23),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-230,0,-23),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 305,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-305,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 305,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-305,0,-79+70),Angle(0,180,0),false,"717")
    end
    ...
    self.InteractionZones = {
        {
            ...
            Pos = Vector(330+20, -30, 0), Radius = 20,
        },
        {
            ID = "FrontTrainLineIsolationToggle",
            Pos = Vector(330+20, 31, 0), Radius = 20,
        },
        {
            ID = "RearTrainLineIsolationToggle",
            Pos = Vector(-331-20, -30, 5), Radius = 20,
        },
        {
            ID = "RearBrakeLineIsolationToggle",
            Pos = Vector(-331-20, 31, 5), Radius = 20,
        },
        {
            ID = "RearDoor",
