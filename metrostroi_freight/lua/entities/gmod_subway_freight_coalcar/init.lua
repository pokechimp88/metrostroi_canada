...
ENT.BogeyDistance = 360 -- Needed for gm trainspawner
ENT.SyncTable = {
...
function ENT:Initialize()
    ...
    self:SetModel("models/gsgtrainprops/trains/rolling_stock/bathtub_thrall_coal.mdl") --FIXME
    ...
    -- Create bogeys
    self.FrontBogey = self:CreateBogey(Vector(180,0,-23),Angle(0,180,0),true,"702")
    self.RearBogey  = self:CreateBogey(Vector(-180,0,-23),Angle(0,0,0),false,"702")
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 260,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-260,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 260,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-260,0,-79+70),Angle(0,180,0),false,"717")
    end
