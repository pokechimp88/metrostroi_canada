...
function ENT:Initialize()
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 255,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-255,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 255,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-255,0,-79+70),Angle(0,180,0),false,"717")
    end
