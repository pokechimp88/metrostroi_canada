...
function ENT:Initialize()
    ...
    self:SetModel("models/hanksabutt/rollingstock/tankers/tanker_26k.mdl") --FIXME
    ...
    if Metrostroi.BogeyOldMap then
        self.FrontCouple = self:CreateCouple(Vector( 318,0,-77+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-318,0,-77+70),Angle(0,180,0),false,"717")
    else
        self.FrontCouple = self:CreateCouple(Vector( 318,0,-79+70),Angle(0,0,0),true,"717")
        self.RearCouple  = self:CreateCouple(Vector(-318,0,-79+70),Angle(0,180,0),false,"717")
    end
