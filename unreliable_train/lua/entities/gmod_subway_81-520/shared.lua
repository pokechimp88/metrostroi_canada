...
ENT.PrintName    = "81-520 (Bucket custom)"
ENT.Author       = ""
ENT.Contact      = ""
ENT.Purpose      = ""
ENT.Instructions = ""
...
ENT.Cameras = {
  ...
  { Vector(407, 40, 50), Angle(10, 180, 0), "Train.Common.ASNP" },
...
function ENT:InitializeSounds()
  ...
  self.SoundPositions["bpsn1"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn2"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn3"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn4"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn5"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn6"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn7"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn8"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn9"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn10"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn11"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  self.SoundPositions["bpsn12"] = { 500, 1e9, Vector(0, 45, -448), 0.1 }
  --Подвагонка
  ...
  self.SoundPositions["kru_0_1"] = { 80, 1e9, Vector(444, 16.5, -7) }
  self.SoundPositions["kru_1_2"] = { 80, 1e9, Vector(444, 16.5, -7) }
  self.SoundPositions["kru_2_1"] = { 80, 1e9, Vector(444, 16.5, -7) }
  self.SoundPositions["kru_1_0"] = { 80, 1e9, Vector(444, 16.5, -7) }
  self.SoundPositions["kru_2_3"] = { 80, 1e9, Vector(444, 16.5, -7) }
  self.SoundPositions["kru_3_2"] = { 80, 1e9, Vector(444, 16.5, -7) }
  ...
  self.SoundNames["ring"] = { loop = 0.0, "subway_trains/717/ring/ring_start.wav", "subway_trains/717/ring/ring_loop.wav",
    "subway_trains/717/ring/ring_end.wav" }
  self.SoundPositions["ring"] = { 60, 1e9, Vector(443.8, 0, -3.2), 0.43 }

  self.SoundNames["ring2"] = { loop = 0.25, "subway_trains/717/ring/ringc_start.wav",
    "subway_trains/717/ring/ringc_loop.wav", "subway_trains/717/ring/ringc_end.mp3" }
  self.SoundPositions["ring2"] = self.SoundPositions["ring"]
  self.SoundNames["ring3"] = { loop = 0.1, "subway_trains/717/ring/ringch_start.wav",
    "subway_trains/717/ring/ringch_loop.wav", "subway_trains/717/ring/ringch_end.wav" }
  ...
  self.SoundNames["ring6"] = { loop = 0.0, "subway_trains/717/ring/ring2_loop.wav",
    "subway_trains/717/ring/ring2_loop.wav", "subway_trains/717/ring/ring2_end.wav" }
  self.SoundPositions["ring6"] = { 60, 1e9, Vector(443.8, 0, -3.2), 0.5 }

  self.SoundNames["ring_old"] = { loop = 0.15, "subway_trains/717/ring/ringo_start.wav",
    "subway_trains/717/ring/ringo_loop.wav", "subway_trains/717/ring/ringo_end.mp3" }
...
self.SoundPositions["horn"] = {1100,1e9,Vector(450,0,-55),1.5}
...
function ENT:InitializeSystems()
  ...
  self:LoadSystem("Electric", "81_717_ars_mp_Electric")
  -- Токоприёмник
...
ENT.Spawner = {
  model = {
    ...
    "models/metrostroi_train/81-718/mask.mdl",
  ...
  { "MaskType", "Spawner.717.MaskType", "List", { "2-2", "2-2-2", "3-3 (718)" } },
  ...
  { "RingType", "Spawner.717.RingType", "List",
    { "Spawner.717.Common.Random", "Spawner.717.RingType.1", "Spawner.717.RingType.2", "Spawner.717.RingType.3",
      "Spawner.717.RingType.4", "Spawner.717.RingType.5", "Spawner.717.RingType.6", "Spawner.717.RingType.7",
      "Spawner.717.RingType.8", "Spawner.717.RingType.9", "Spawner.717.RingType.10" } },
