...
if Map:find("prizmaaline") and Map:find("v1") then
else 
return 
end
...
Metrostroi.AddLastStationTex("710", 903, "models/metrostroi_skins/717_schemes/stm_old/longeuil")
Metrostroi.AddLastStationTex("710", 505, "models/metrostroi_skins/717_schemes/stm_old/berri")
Metrostroi.AddLastStationTex("707", 903, "models/metrostroi_skins/717_schemes/stm_old/longeuil")
Metrostroi.AddLastStationTex("707", 505, "models/metrostroi_skins/717_schemes/stm_old/berri")
Metrostroi.AddLastStationTex("717", 903, "models/metrostroi_skins/717_schemes/stm_old/longeuil")
Metrostroi.AddLastStationTex("717", 505, "models/metrostroi_skins/717_schemes/stm_old/berri")
Metrostroi.AddLastStationTex("717", 903, "models/metrostroi_skins/717_schemes/stm/longeuil")
Metrostroi.AddLastStationTex("717", 505, "models/metrostroi_skins/717_schemes/stm/berri")

Metrostroi.AddPassSchemeTex("722", "MTL",{
	"models/metrostroi_skins/722_schemes/mtl/722_jaune_inv",
	"models/metrostroi_skins/722_schemes/mtl/722_jaune",
})
