...
if Map:find("gm_metro_sunnytown_v2") then
...
Metrostroi.AddANSPAnnouncer("GO Lakeshore West Line", 
	{
		...
		burlington = {"subway_announcers/en_go_c1/burlington.mp3", 0.8},
		bronte = {"subway_announcers/en_go_c1/bronte.mp3", 0.7},
		appleby = {"subway_announcers/en_go_c1/appleby.mp3", 0.8},
		...
		en_burlington = {"subway_announcers/en_go/burlington.mp3", 0.86},		
		en_bronte = {"subway_announcers/en_go/bronte.mp3", 0.76},		
		en_appleby = {"subway_announcers/en_go/appleby.mp3", 0.78},
		...
		fr_burlington = {"subway_announcers/fr_go/burlington.mp3", 1.12},		
		fr_bronte = {"subway_announcers/fr_go/bronte.mp3", 0.84},		
		fr_appleby = {"subway_announcers/fr_go/appleby.mp3", 0.8}
	...
	{
		{
			...
			{
				107, "Oakville",
				arr = {{"go_chime","prib","en_oakville","prib_f","fr_oakville"},{"go_chime","prib","en_oakville","prib_f","fr_oakville"}},
				arrlast = {{"go_chime","prib","en_oakville","prib_f","fr_oakville","last","last_f"}, {"go_chime","prib","en_oakville","prib_f","fr_oakville","last","last_f"}, "en_oakville"},
				dep = {{"odz","bronte"}, {"odz","clarkson"}},
				not_last = {0.2, "train_goes_to", "oakville"},
			},
			{
				108, "Bronte",
                arr = {{"go_chime","prib","en_bronte","prib_f","fr_bronte"},{"go_chime","prib","en_bronte","prib_f","fr_bronte"}},
				dep = {{"odz","appleby"},{"odz","oakville"}},
			},
			{
				109, "Appleby",
                arr = {{"go_chime","prib","en_appleby","prib_f","fr_appleby"},{"go_chime","prib","en_appleby","prib_f","fr_appleby"}},
				dep = {{"odz","burlington"},{"odz","bronte"}},
			},
			{
				110, "Burlington",
				arrlast = {{"go_chime","prib","en_burlington","prib_f","fr_burlington","last","last_f"}, nil, "en_burlington"},
				dep = {nil, {"odz","appleby"}},
			}
		}
	}
...
Metrostroi.AddANSPAnnouncer("GO Lakeshore East Line", 
	{
		...
		oshawa = {"subway_announcers/en_go_c1/oshawa.mp3", 0.8},		
		ajax = {"subway_announcers/en_go_c1/ajax.mp3", 0.8},		
		whitby = {"subway_announcers/en_go_c1/whitby.mp3", 0.8},
		...
		en_oshawa = {"subway_announcers/en_go/oshawa.mp3", 0.75},		
		en_ajax = {"subway_announcers/en_go/ajax.mp3", 0.83},		
		en_whitby = {"subway_announcers/en_go/whitby.mp3", 0.7},
		...
		fr_oshawa = {"subway_announcers/fr_go/oshawa.mp3", 0.78},		
		fr_ajax = {"subway_announcers/fr_go/ajax.mp3", 0.95},		
		fr_whitby = {"subway_announcers/fr_go/whitby.mp3", 0.73}
	...
	{
		{
			...
			{
				107, "Pickering",
				arr = {{"go_chime","prib","en_pickering","prib_f","fr_pickering"},{"go_chime","prib","en_pickering","prib_f","fr_pickering"}},
				arrlast = {{"go_chime","prib","en_pickering","prib_f","fr_pickering","last","last_f"}, {"go_chime","prib","en_pickering","prib_f","fr_pickering","last","last_f"}, "en_pickering"},
				dep = {{"odz","ajax"}, {"odz","rouge_hill"}},
				not_last = {0.2, "train_goes_to", "pickering"},
			},
			{
				108, "Ajax",
                arr = {{"go_chime","prib","en_ajax","prib_f","fr_ajax"},{"go_chime","prib","en_ajax","prib_f","fr_ajax"}},
				dep = {{"odz","whitby"},{"odz","pickering"}},
			},
			{
				109, "Whitby",
                arr = {{"go_chime","prib","en_whitby","prib_f","fr_whitby"},{"go_chime","prib","en_whitby","prib_f","fr_whitby"}},
				dep = {{"odz","oshawa"},{"odz","ajax"}},
			},
			{
				110, "Oshawa",
				arrlast = {{"go_chime","prib","en_oshawa","prib_f","fr_oshawa","last","last_f"}, nil, "en_oshawa"},
				dep = {nil, {"odz","whitby"}},
			}
		}
	}
