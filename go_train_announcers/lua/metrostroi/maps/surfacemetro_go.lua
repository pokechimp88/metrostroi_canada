...
Metrostroi.CurrentMap = "surfacemetro_w"
	...
	{
		{
			...
			},
			{
				...
				dep = {{"odz","kipling"},{"odz","union"}},
			},
			{
				102, "Kipling",
                arr = {{"go_chime","prib","en_kipling","prib_f","fr_kipling"},{"go_chime","prib","en_kipling","prib_f","fr_kipling"}},
				dep = {{"odz","dixie"},{"odz","bloor"}},
				arrlast = {{"go_chime","prib","en_kipling","prib_f","fr_kipling","last","last_f"},{"go_chime","prib","en_kipling","prib_f","fr_kipling","last","last_f"}, "en_kipling"},
			    not_last = {0.2, "train_goes_to", "kipling"},
			},
			{
				103, "Dixie",
	...
	{
		{
			...
			},
			{
				...
				arrlast = {{"go_chime","prib","en_old_cummer","prib_f","fr_old_cummer","last","last_f"},{"go_chime","prib","en_old_cummer","prib_f","fr_old_cummer","last","last_f"}, "en_old_cummer"},
			    not_last = {0.2, "train_goes_to", "old_cummer"},
			},
			{
				103, "Langstaff",
			...
			{
				105, "Gormley",
                arr = {{"go_chime","prib","en_gormley","prib_f","fr_gormley"},{"go_chime","prib","en_gormley","prib_f","fr_gormley"}},
				dep = {{"odz","bloomington"},{"odz","richmond_hill"}},
				arrlast = {{"go_chime","prib","en_gormley","prib_f","fr_gormley","last","last_f"},{"go_chime","prib","en_gormley","prib_f","fr_gormley","last","last_f"}, "en_gormley"},
			    not_last = {0.2, "train_goes_to", "richmond_hill"},
			},
			{
				106, "Bloomington",
				arrlast = {{"go_chime","prib","en_bloomington","prib_f","fr_bloomington","last","last_f"}, nil, "en_bloomington"},
				dep = {nil, {"odz","gormley"}},
			}
		}
	}
