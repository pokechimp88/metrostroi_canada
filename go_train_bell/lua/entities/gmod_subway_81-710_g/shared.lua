...
ENT.PrintName       = "Ezh3 (81-710) GO Transit"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
...
function round(x)
  return x>=0 and math.floor(x+0.3)
end
...
self.SoundNames["ring"] = {loop=0.0,"subway_trains/717/ring/ringp_start.mp3","subway_trains/717/ring/ringp_loop.mp3","subway_trains/717/ring/ringp_end.mp3"}
    self.SoundPositions["ring"] = {1000,1e9,Vector(446.7,50,66.5),1}
    ...
    self.SoundPositions["ring4"] = self.SoundPositions["ring"]
...
local HornType = self:GetNW2Int("HornType",0)
	if HornType == 1 then -- K5LA F40PH
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 2 then -- K5LA CC 215
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 3 then -- K5LA CC 238
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k5la238_start.mp3","subway_trains/common/pneumatic/horn/k5la238_loop.mp3", "subway_trains/common/pneumatic/horn/k5la238_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 4 then -- K5LA CC 202
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 5 then -- K5LA CC 219
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k5la219_start.mp3","subway_trains/common/pneumatic/horn/k5la219_loop.mp3", "subway_trains/common/pneumatic/horn/k5la219_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 6 then -- K5LA CC 226
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 7 then -- K5LA CC 244
	...
	elseif HornType == 8 then -- K5H
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 9 then -- K5LA CC 201
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 10 then -- K5LA CC 235 
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 11 then -- K5LA F59PH
	...
	elseif HornType == 12 then -- K5HL
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 13 then -- K3L CP
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k3l_loop.mp3","subway_trains/common/pneumatic/horn/k3l_loop.mp3", "subway_trains/common/pneumatic/horn/k3l_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),2}
	elseif HornType == 14 then -- K3H CN
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 15 then -- P2 Metrolink
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/p2m_start.mp3","subway_trains/common/pneumatic/horn/p2m_loop.mp3", "subway_trains/common/pneumatic/horn/p2m_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 16 then -- P2 CalTrain
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,67.1),1.5}
	elseif HornType == 17 then -- K5CA-LS emergency
    ...
    for k,v in ipairs(self.AnnouncerPositions) do
        ...
        self.SoundNames["announcer_noise2_"..k] = {loop=true,"subway_announcers/upo/noiset2.wav"}
        self.SoundPositions["announcer_noise2_"..k] = {v[2] or 300,1e9,v[1],v[3]*0.7}
    end
end

function ENT:InitializeSystems()
    -- Электросистема Е (АРС)
    self:LoadSystem("Electric","81_710_g_Electric")
...
ENT.Spawner = {
	...
	spawnfunc = function(i,tbls,tblt)
        ...
        if 1<i and i<WagNum  then
            return tbls.Ezh3Wagons and "gmod_subway_81-710_int_g" or "gmod_subway_81-508g"
        else
            return "gmod_subway_81-710_g"
        end
    end,
    interim = "gmod_subway_81-508g",
    func = function(ent,i,maxi)
        if ent:GetClass() == "gmod_subway_81-710_g" then
...
{"RingType","Spawner.710.RingType","List",{"Spawner.710.RingType.1","Spawner.710.RingType.2","Spawner.710.RingType.3","Spawner.710.RingType.4","Spawner.710.RingType.5","Spawner.710.RingType.6","Spawner.710.RingType.7","Spawner.710.RingType.8","Spawner.710.RingType.9","Spawner.710.RingType.10","Spawner.710.RingType.11","Spawner.710.RingType.12","Spawner.710.RingType.13","Spawner.710.RingType.14","Spawner.710.RingType.15","Spawner.710.RingType.16"}},
	...
	{"Ezh3Wagons","Spawner.710.Ezh3Wagons","Boolean"},
	{"HornType","Spawner.710.HornType","List",{"Spawner.710.HornType.1", "Spawner.710.HornType.2", "Spawner.710.HornType.3","Spawner.710.HornType.4", "Spawner.710.HornType.5","Spawner.710.HornType.6","Spawner.710.HornType.7","Spawner.710.HornType.8","Spawner.710.HornType.9","Spawner.710.HornType.10","Spawner.710.HornType.11","Spawner.710.HornType.12","Spawner.710.HornType.13","Spawner.710.HornType.14","Spawner.710.HornType.15","Spawner.710.HornType.16","Spawner.710.HornType.17","Spawner.710.HornType.18"}}
