...
ENT.PrintName = "81-717.6 (Bombardier CEM Cab Car)"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
ENT.Category        = "Metrostroi (trains)"
ENT.SkinsType = "81-717_6"
ENT.Model = "models/metrostroi_train/81-717.6/6000.mdl"
...
ENT.AnnouncerPositions = {
    {Vector(465,-43 ,5),80,0.4},
    {Vector(-3,-60, 62),250,0.3},
    {Vector(-3,60 ,62),250,0.3},
}
ENT.Cameras = {
   --{Vector(440,-40,50),Angle(0,180,0),"Train.717.Breakers","AV_C"},
    --{Vector(407.5+35,-49,10),Angle(0,180,0),"Train.717.VB","Battery_C"},
    {Vector(407.5+25,-40,37),Angle(0,180,0),"Train.717.Breakers","AV_R"},
    {Vector(407.5+20,-40.5,5.5),Angle(0,180,0),"Train.717.VB","Battery_R"},
    {Vector(420,7,22),Angle(0,180,0),"Train.717.VBD","VBD_R"},
    {Vector(407.5+13,-47,-20),Angle(40,270-15,0),"Train.Common.UAVA"},
    {Vector(450,-40,10),Angle(80,-10,0),"Train.Common.PneumoPanels"},
    {Vector(407.5+35,40,10),Angle(0,90-17,0),"Train.Common.HelpersPanel"},
    {Vector(447,-50,5),Angle(10,-75,0),"Train.Common.ASNP"},
    {Vector(460,-35,10),Angle(30,0,0),"Train.Common.IGLA"},
    --{Vector(495,-45,0)  ,Angle(20,180,0),"Train.Common.RouteNumber"},
    {Vector(500,-15,50)  ,Angle(20,180,0),"Train.Common.LastStation"},
    {Vector(482,0,30),Angle(55,0,0),"Train.Common.CouplerCamera"},
}
...
function ENT:InitializeSounds()
	...
	for i=1,7 do
        ...
        self.SoundPositions["vent"..i] = {130,1e9,Vector(yventpos[i],0,30),0.1}
    end
    ...
    self.SoundNames["bpsn1"] = {"subway_trains/717/bpsn/mp54ac_2.mp3", loop=true}
    self.SoundNames["bpsn2"] = {"subway_trains/717/old.wav", loop=true}
    ...
    self.SoundPositions["bpsn1"] = {500,1e9,Vector(0,45,-448),5}
    ...
    self.SoundPositions["revers_0-f"] = 	{80,1e9,Vector(458,15,-5),0.85}
    self.SoundPositions["revers_f-0"] = 	{80,1e9,Vector(458,15,-5),0.85}
    self.SoundPositions["revers_0-b"] = 	{80,1e9,Vector(458,15,-5),0.85}
    self.SoundPositions["revers_b-0"] = 	{80,1e9,Vector(458,15,-5),0.85}
    self.SoundPositions["revers_in"] = 		{80,1e9,Vector(458,15,-5),0.85}
    self.SoundPositions["revers_out"] = 	{80,1e9,Vector(458,15,-5),0.85}

    self.SoundNames["kru_in"] = {
        "subway_trains/717/kru/kru_insert1.mp3",
        "subway_trains/717/kru/kru_insert2.mp3"
    }
    self.SoundPositions["kru_in"] = {80,1e9,Vector(458,15,-5)}
    ...
    self.SoundPositions["kru_out"] = {80,1e9,Vector(458,15,-5)}
    ...
    self.SoundPositions["kru_0_1"] = {80,1e9,Vector(458,15,-5)}
    self.SoundPositions["kru_1_2"] = {80,1e9,Vector(458,15,-5)}
    self.SoundPositions["kru_2_1"] = {80,1e9,Vector(458,15,-5)}
    self.SoundPositions["kru_1_0"] = {80,1e9,Vector(458,15,-5)}
    self.SoundPositions["kru_2_3"] = {80,1e9,Vector(458,15,-5)}
    self.SoundPositions["kru_3_2"] = {80,1e9,Vector(458,15,-5)}
    ...
    self.SoundNames["release1"] = {loop=true,"subway_trains/720/pneumo_release.wav"}
    self.SoundPositions["release1"] = {350,1e9,Vector(-183,0,-70),0}
	...
	self.SoundNames["kv70_0_t1"] = "subway_trains/dot_six/grkv/kv_t2_t3.mp3" --{"subway_trains/717/kv70/kv70_0-t1_1.mp3","subway_trains/717/kv70/kv70_0-t1_2.mp3"}
	self.SoundNames["kv70_t1_0_fix"]= "subway_trains/dot_six/grkv/kv_t1_0.mp3"--{"subway_trains/717/kv70/kv70_t1-0_fix_1.mp3","subway_trains/717/kv70/kv70_t1-0_fix_2.mp3","subway_trains/717/kv70/kv70_t1-0_fix_3.mp3","subway_trains/717/kv70/kv70_t1-0_fix_4.mp3"}
	self.SoundNames["kv70_t1_0"] = "subway_trains/dot_six/grkv/kv_t1_0.mp3" --{"subway_trains/717/kv70/kv70_t1-0_1.mp3","subway_trains/717/kv70/kv70_t1-0_2.mp3"}
	self.SoundNames["kv70_t1_t1a"] = "subway_trains/dot_six/grkv/kv_x1_x2.mp3" --{"subway_trains/717/kv70/kv70_t1-t1a_1.mp3","subway_trains/717/kv70/kv70_t1-t1a_2.mp3"}
	self.SoundNames["kv70_t1a_t1"] = "subway_trains/dot_six/grkv/kv_x1_x2.mp3" --{"subway_trains/717/kv70/kv70_t1a-t1_1.mp3","subway_trains/717/kv70/kv70_t1a-t1_2.mp3"}
	self.SoundNames["kv70_t1a_t2"] = "subway_trains/dot_six/grkv/kv_0_t1.mp3" --{"subway_trains/717/kv70/kv70_t1a-t2_1.mp3","subway_trains/717/kv70/kv70_t1a-t2_2.mp3"}
	self.SoundNames["kv70_t2_t1a"] = "subway_trains/dot_six/grkv/kv_t3_t2.mp3" --{"subway_trains/717/kv70/kv70_t2-t1a_1.mp3","subway_trains/717/kv70/kv70_t2-t1a_2.mp3"}
	self.SoundNames["kv70_0_x1"] = "subway_trains/dot_six/grkv/kv_x1_0.mp3" --{"subway_trains/717/kv70/kv70_0-x1_1.mp3","subway_trains/717/kv70/kv70_0-x1_2.mp3"}
	self.SoundNames["kv70_x1_0"] = "subway_trains/dot_six/grkv/kv_x1_0.mp3" --{"subway_trains/717/kv70/kv70_x1-0_1.mp3","subway_trains/717/kv70/kv70_x1-0_2.mp3"}
	self.SoundNames["kv70_x1_x2"] = "subway_trains/dot_six/grkv/kv_x1_x2.mp3" --{"subway_trains/717/kv70/kv70_x1-x2_1.mp3","subway_trains/717/kv70/kv70_x1-x2_2.mp3"}
	self.SoundNames["kv70_x2_x1"] = "subway_trains/dot_six/grkv/kv_x2_x1.mp3" --{"subway_trains/717/kv70/kv70_x2-x1_1.mp3","subway_trains/717/kv70/kv70_x2-x1_2.mp3"}
	self.SoundNames["kv70_x2_x3"] = "subway_trains/dot_six/grkv/kv_x2_x3.mp3" --{"subway_trains/717/kv70/kv70_x2-x3_1.mp3","subway_trains/717/kv70/kv70_x2-x3_2.mp3"}
	self.SoundNames["kv70_x3_x2"] = "subway_trains/dot_six/grkv/kv_x1_x2.mp3" --{"subway_trains/717/kv70/kv70_x3-x2_1.mp3","subway_trains/717/kv70/kv70_x3-x2_2.mp3"}
	self.SoundPositions["kv70_fix_on"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_fix_off"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_0_t1"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t1_0_fix"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t1_0"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t1_t1a"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t1a_t1"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t1a_t2"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_t2_t1a"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_0_x1"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_x1_0"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_x1_x2"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_x2_x1"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_x2_x3"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	self.SoundPositions["kv70_x3_x2"] = {60,1e9,Vector(442.2+15,17.0+1.4-20,-5),0.5}
	
	
	
	
	self.SoundNames["kv70_0_t1_2"] = self.SoundNames["kv70_0_t1"]
	self.SoundNames["kv70_t1_0_fix_2"]= self.SoundNames["kv70_t1_0_fix"]
	self.SoundNames["kv70_t1_0_2"] = self.SoundNames["kv70_t1_0"]
	self.SoundNames["kv70_t1_t1a_2"] = self.SoundNames["kv70_t1_t1a"]
	self.SoundNames["kv70_t1a_t1_2"] = self.SoundNames["kv70_t1a_t1"]
	self.SoundNames["kv70_t1a_t2_2"] = self.SoundNames["kv70_t1a_t2"]
	self.SoundNames["kv70_t2_t1a_2"] = self.SoundNames["kv70_t2_t1a"]
	self.SoundNames["kv70_0_x1_2"] = self.SoundNames["kv70_0_x1"]
	self.SoundNames["kv70_x1_0_2"] = self.SoundNames["kv70_x1_0"]
	self.SoundNames["kv70_x1_x2_2"] = self.SoundNames["kv70_x1_x2"]
	self.SoundNames["kv70_x2_x1_2"] = self.SoundNames["kv70_x2_x1"]
	self.SoundNames["kv70_x2_x3_2"] = self.SoundNames["kv70_x2_x3"]
	self.SoundNames["kv70_x3_x2_2"] = self.SoundNames["kv70_x3_x2"]
	self.SoundPositions["kv70_0_t1_2"] = self.SoundPositions["kv70_0_t1"]
	self.SoundPositions["kv70_t1_0_fix_2"] = self.SoundPositions["kv70_t1_0_fix"]
	self.SoundPositions["kv70_t1_0_2"] = self.SoundPositions["kv70_t1_0"]
	self.SoundPositions["kv70_t1_t1a_2"] = self.SoundPositions["kv70_t1_t1a"]
	self.SoundPositions["kv70_t1a_t1_2"] = self.SoundPositions["kv70_t1a_t1"]
	self.SoundPositions["kv70_t1a_t2_2"] = self.SoundPositions["kv70_t1a_t2"]
	self.SoundPositions["kv70_t2_t1a_2"] = self.SoundPositions["kv70_t2_t1a"]
	self.SoundPositions["kv70_0_x1_2"] = self.SoundPositions["kv70_0_x1"]
	self.SoundPositions["kv70_x1_0_2"] = self.SoundPositions["kv70_x1_0"]
	self.SoundPositions["kv70_x1_x2_2"] = self.SoundPositions["kv70_x1_x2"]
	self.SoundPositions["kv70_x2_x1_2"] = self.SoundPositions["kv70_x2_x1"]
	self.SoundPositions["kv70_x2_x3_2"] = self.SoundPositions["kv70_x2_x3"]
	self.SoundPositions["kv70_x3_x2_2"] = self.SoundPositions["kv70_x3_x2"]
    ...
    self.SoundPositions["ring"] = {1000,1e9,Vector(430.7,55,-62),1}
    ...
    self.SoundPositions["ring4"] = {1000,1e9,Vector(430.7,55,-62),1}
	...
	if self:GetNW2Bool("SAVPE_UPPS",false) then
		self.SoundNames["upps"]         = {"subway_trains/dot_six/stn_check.mp3"}
		self.SoundPositions["upps"] = {60,1e9,Vector(443,-64,4),1}
	else
	...
	if HornType == 1 then
		...
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,80.9),2}
	...
	elseif HornType == 5 then
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k2la_loop.mp3","subway_trains/common/pneumatic/horn/k2la_loop.mp3", "subway_trains/common/pneumatic/horn/k2la_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,80.9),1.5}
	...
	elseif HornType == 13 then
		self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k5la202_start.mp3","subway_trains/common/pneumatic/horn/k5la202_loop.mp3", "subway_trains/common/pneumatic/horn/k5la202_end.mp3"}
		self.SoundPositions["horn"] = {1100,1e9,Vector(444.7,0,80.9),1.5}
    ...
    for i=0,3 do
        for k=0,1 do
			math.randomseed(i + k + CurTime())
			local rollrand = tostring(math.random(2,9))
			--local loud = 2
			--if rollrand == 1 then loud = 0.3 end
            self.SoundNames["door"..i.."x"..k.."r"] = {"subway_trains/dot_six/doors/new_roll_"..rollrand..".mp3",loop=true}
            self.SoundPositions["door"..i.."x"..k.."r"] = {150,1e9,GetDoorPosition(i,k),1}
            self.SoundNames["door"..i.."x"..k.."o"] = {"subway_trains/dot_six/doors/new_open_1.mp3","subway_trains/dot_six/doors/new_open_2.mp3","subway_trains/dot_six/doors/new_open_3.mp3","subway_trains/dot_six/doors/new_open_4.mp3"}
            self.SoundPositions["door"..i.."x"..k.."o"] = {350,1e9,GetDoorPosition(i,k),0.5}
            self.SoundNames["door"..i.."x"..k.."c"] = {"subway_trains/dot_six/doors/new_close_1.mp3","subway_trains/dot_six/doors/new_close_2.mp3","subway_trains/dot_six/doors/new_close_3.mp3","subway_trains/dot_six/doors/new_close_4.mp3"}
            self.SoundPositions["door"..i.."x"..k.."c"] = {400,1e9,GetDoorPosition(i,k),0.5}
            self.SoundNames["door"..i.."x"..k.."s"] = {"subway_trains/dot_six/doors/new_open_start_1.mp3","subway_trains/dot_six/doors/new_open_start_2.mp3","subway_trains/dot_six/doors/new_open_start_3.mp3","subway_trains/dot_six/doors/new_open_start_4.mp3","subway_trains/dot_six/doors/new_open_start_5.mp3"}
            self.SoundPositions["door"..i.."x"..k.."s"] = {400,1e9,GetDoorPosition(i,k),0.5}
        end
    end

    for k,v in ipairs(self.AnnouncerPositions) do
        self.SoundNames["announcer_buzz"..k] = {loop=true,"subway_announcers/upo/noiset2.wav"}
...
function ENT:InitializeSystems()
	...
	self:LoadSystem("81_71_6_other")
	
	--вентиляция
	self:LoadSystem("81_71_6_Vent")
	
	--дополнительные лампы на панели арс
	self:LoadSystem("81_717_6_dop_ars")
	
	--наддверные лампы
	self:LoadSystem("81_71_6_OnDoor_Lamps")

	--табло с инфой о маршруте
	self:LoadSystem("81_717_CEM_route_info")
	
end

function ENT:PostInitializeSystems()
	self.PostInitializeSystems1(self)
...
ENT.NumberRanges = {{300,380}}
ENT.Spawner = {
    model = {
        "models/metrostroi_train/81-717.6/6000.mdl",
    ...
    interim = "gmod_subway_81-714_6_cem",
    {"Texture","Spawner.Texture","List", function()
		local tbl = {}
		for k,v in pairs(MetrostroiDotSixSkins.Train) do
    ...
    {"PassTexture","Spawner.PassTexture","List", function()
		local tbl = {}
		for k,v in pairs(MetrostroiDotSixSkins.Int) do
			tbl[table.Count(tbl) + 1] = v.Name
		end
		return tbl
	end,false},
    {"CabTexture","Spawner.CabTexture","List", function()
		local tbl = {}
		for k,v in pairs(MetrostroiDotSixSkins.Cab) do
			tbl[table.Count(tbl) + 1] = v.Name
		end
		return tbl
	end,false},
	...
	{"SAVPE_UPPS","Replace UPPS sound","Boolean"},
	{"HornType","Spawner.717.HornType","List",{"Spawner.717.HornType.1", "Spawner.717.HornType.2", "Spawner.717.HornType.3","Spawner.717.HornType.4","Spawner.717.HornType.5","Spawner.717.HornType.6","Spawner.717.HornType.7","Spawner.717.HornType.8","Spawner.717.HornType.9","Spawner.717.HornType.10","Spawner.717.HornType.11","Spawner.717.HornType.12","Spawner.717.HornType.13","Spawner.717.HornType.14","Spawner.717.HornType.15"}},
    ...
    {"Cran","Spawner.717.CranType","List",{"Double (334+013)","Single (013 only)"}},
