...
ENT.ClientProps["bell"] = {
    ...
    pos = Vector(469,0,63), -- cab mounted (F59PH style, obstructs top headlights, may need SPB 540 2-2-2 mask)
    ang = Angle(0,0,0),
    hide = 2,
}
...
ENT.ClientProps["Headlights111"] = {
    ...
    pos =  Vector(0.4,36.8,77.4), -- fix position for the left upper headlight
    ang = Angle(0,0,0),
    nohide=true,
}
ENT.ClientProps["Headlights333"] = {
    model = "models/metrostroi_train/81-717.6/headlight.mdl",
    pos = Vector(-0.1,91.5,0),
    ang = Angle(0,0,0),
    nohide=true,
}
ENT.ClientProps["Headlights444"] = {
    model = "models/metrostroi_train/81-717.6/headlight.mdl",
    pos = Vector(-0.1,-8.5,0),
    ang = Angle(0,0,0),
    nohide=true,
}
...
ENT.ButtonMap["Block5_6"] = {
  ...
  buttons = {
    ...
    { ID = "1:KVTSet", x = 243.5 , y = 40, radius = 20, tooltip = "", model = {
    ...
    { ID = "1:KVTRSet", x = 293, y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_red.mdl", z = -3,
      var = "KVTR", speed = 16, vmin = 1, vmax = 0,
      sndvol = 0.07, snd = function(val) return val and "button1_on" or "button1_off" end,
      sndmin = 60, sndmax = 1e3 / 3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "2:KVTSet", x = 293, y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_red.mdl", z = -3,
      var = "KVT", speed = 16, vmin = 1, vmax = 0,
      sndvol = 0.07, snd = function(val) return val and "button1_on" or "button1_off" end,
      sndmin = 60, sndmax = 1e3 / 3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "2:KVTRSet", x = 243.5 , y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_red.mdl", z = -3,
      var = "KVTR", speed = 16, vmin = 1, vmax = 0,
      sndvol = 0.07, snd = function(val) return val and "button1_on" or "button1_off" end,
      sndmin = 60, sndmax = 1e3 / 3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "!LZPLight", x = 333, y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", ignorepanel = true, skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 63, x = -0.3, y = -0.3, z = 20.6,
        var = "RZP", color = Color(255, 60, 40) },
    } },
    { ID = "VZ1Set", x = 372.5, y = 40, radius = 20, tooltip = "", model = {
    ...
    { ID = "V13Toggle", x = 443, y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-502/buttons/tumbler_w_a.mdl", ang = 180, z = -3,
      var = "V13", speed = 16,
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    ...
    { ID = "KDLSet", x = 60, y = 170, radius = 20, tooltip = "", model = {
      ...
      sndvol = 0.07, snd = function(val) return val and "button3_on" or "button3_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "R_VPRToggle", x = 110, y = 83, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-502/buttons/tumbler_w_a.mdl", ang = 180, z = -3,
      var = "R_VPR", speed = 16,
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    ...
    { ID = "VozvratRPSet", x = 107, y = 132, radius = 20, tooltip = "", model = {
      ...
      sndvol = 0.07, snd = function(val) return val and "button2_on" or "button1_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },

    { ID = "!GreenRPLight", x = 155, y = 132, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 2, x = -0.3, y = -0.3, z = 20.6,
        var = "GreenRP", color = Color(100, 255, 100) }
    } },
    { ID = "!AVULight", x = 333, y = 98, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 62, x = -0.3, y = -0.3, z = 20.6,
        var = "AVU", color = Color(255, 60, 40) },
    } },
    { ID = "!LKVPLight", x = 377, y = 98, radius = 20, tooltip = "", model = {
      ...
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 25, x = -0.3, y = -0.3, z = 20.6,
        var = "LKVP", color = Color(255, 170, 110) },
    } },
    { ID = "!SPLight", x = 412, y = 40, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", ignorepanel = true, skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 63, x = -0.3, y = -0.3, z = 20.6,
        var = "LSP", color = Color(100, 255, 50) },
    } },
    { ID = "OtklAVUToggle", x = 243.5, y = 94, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_tumbler_t1.mdl", ang = 180, z = -4,
      var = "OtklAVU", speed = 16,
      plomb = { model = "models/metrostroi_train/81/plomb.mdl", ang = 270, x = -1, y = 26, var = "OtklAVUPl",
        ID = "OtklAVUPl", },
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "OtklBVSet", x = 293, y = 94, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_black.mdl", z = -3,
      var = "OtklBV", speed = 16, vmin = 1, vmax = 0,
      sndvol = 0.07, snd = function(val) return val and "button1_on" or "button1_off" end,
      sndmin = 60, sndmax = 1e3 / 3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "V11Toggle", x = 355, y = 69, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-502/buttons/tumbler_w_a.mdl", ang = 180, z = -3,
      var = "V11", speed = 16,
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    } },
    { ID = "V12Toggle", x = 400, y = 69, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-502/buttons/tumbler_w_a.mdl", ang = 180, z = -3,
      var = "V12", speed = 16,
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    ...
    { ID = "KSNSet", x = 377, y = 133, radius = 20, tooltip = "", model = {
      ...
      sndvol = 0.07, snd = function(val) return val and "button3_on" or "button2_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    { ID = "RingToggle", x = 420, y = 133, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-502/buttons/button_big_1.mdl", z = 1,
      var="Ring",speed=16,
      sndvol = 0.07, snd = function(val) return val and "button2_on" or "button2_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    { ID = "DoorBuzzerSet", x = 420, y = 94, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_red.mdl", z = -3,
      var = "DoorBuzzer", speed = 16, vmin = 1, vmax = 0,
      sndvol = 0.07, snd = function(val) return val and "button3_on" or "button2_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "ALSToggle", x = 263, y = 134, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_tumbler_t2.mdl", ang = 180, z = -6,
      var = "ALS", speed = 16,
      plomb = { model = "models/metrostroi_train/81/plomb.mdl", ang = 90, x = 2, y = -26, z = 2, var = "ALSPl",
        ID = "ALSPl", },
      sndvol = 1, snd = function(val) return val and "switchbl_on" or "switchbl_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "OVTToggle", x = 240, y = 181, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_tumbler_pp250.mdl", ang = 180, z = -8,
      var = "OVT", speed = 16,
      plomb = { model = "models/metrostroi_train/81/plomb.mdl", ang = 270, x = -1, y = 26, z = 4, var = "OVTPl",
        ID = "OVTPl", },
      sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    } },
...
ENT.ButtonMap["Block7"] = {
  ...
  buttons = {
    ...
    { ID = "ARS13Toggle", x = 35, y = 130, radius = 20, tooltip = "", model = {
    ...
    { ID = "VAHToggle", x = 140, y = 180.5, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_tumbler_pp250.mdl", ang = 180, z = -4,
      var = "VAH", speed = 16,
      plomb = { model = "models/metrostroi_train/81/plomb.mdl", ang = 270, x = -1, y = 28, z = 4, var = "VAHPl",
        ID = "VAHPl", },
      sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end,
      sndmin = 90, sndmax = 1e3, sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "KRPSet", x = 43, y = 30, radius = 20, tooltip = "", model = {
      ...
      sndvol = 0.07, snd = function(val) return val and "button1_on" or "button1_off" end, sndmin = 60, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "!PNT", x = 60, y = 130, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 2, z = -1,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 43, x = -0.3, y = -0.3, z = 20.6,
        var = "PN", color = Color(255, 170, 110) },
    } },
    ...
    { ID = "!PNW", x = 135, y = 130, radius = 20, tooltip = "", model = {
      ...
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 81, x = -0.3, y = -0.3, z = 20.6,
        var = "BrW", color = Color(255, 130, 90) },
    } },
  }
}
...
ENT.ButtonMap["Block1"] = {
  ...
  buttons = {
    { ID = "VMKToggle", x = 39, y = 30, radius = 20, tooltip = "", model = {
      ...
      var = "VMK", speed = 16,
      sndvol = 1, snd = function(val) return val and "switch_on" or "switch_off" end, sndmin = 90, sndmax = 1e3,
      sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "Radio13Set", x = 130, y = 80, radius = 20, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_button_black.mdl", z = -2,
...
ENT.ButtonMap["Block2_2"] = {
  ...
  buttons = {
    { ID = "!Speedometer1", x = 109, y = 18.5, w = 13, h = 22, tooltip = "", model = {
      name = "SSpeed2", model = "models/metrostroi_train/81-717/segments/segment_mvm.mdl", color = Color(175, 250, 20),
      skin = 0, z = -2, ang = Angle(0, 0, -90),
    } },
    { ID = "!Speedometer2", x = 121, y = 18.5, w = 13, h = 22, tooltip = "", model = {
      name = "SSpeed1", model = "models/metrostroi_train/81-717/segments/segment_mvm.mdl", color = Color(175, 250, 20),
      skin = 0, z = -2, ang = Angle(0, 0, -90),
    } },

    { ID = "!ARSOch", x = 45 + 26.67 * 0, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SAOCh",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s04.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR04" },
    } },
    { ID = "!ARS0", x = 45 + 26.67 * 1, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SA0",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s0.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR0" },
    } },
    { ID = "!ARS40", x = 45 + 26.67 * 2, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SA40",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s40.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR40" },
    } },
    { ID = "!ARS60", x = 45 + 26.67 * 3, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SA60",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s60.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR60" },
    } },
    { ID = "!ARS70", x = 45 + 26.67 * 4, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SA70",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s70.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR70" },
    } },
    { ID = "!ARS80", x = 45 + 26.67 * 5, y = 51.1, w = 18, h = 10, tooltip = "", model = {
      name = "SA80",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_s80.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "AR80" },
    } },

    { ID = "!LampLSD1", x = 45 + 26.67 * 0, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SSD1",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lsd.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "SD" },
    } },
    ...
    { ID = "!LampLVD", x = 45 + 26.67 * 7.97, y = 57.2 - 20.0 * 1, w = 18, h = 10, tooltip = "", model = {
      name = "SVD",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lvd.mdl", ang = Angle(0, 0, 90), z = -
          2, var = "VD" },
    } },
    { ID = "!LampLHRK", x = 45 + 26.67 * 2.51, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SHRK",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_rk.mdl", z = -2, ang = Angle(0, 0, 90),
        var = "HRK" },
    } },
    { ID = "!LampLST", x = 45 + 26.67 * 7.96, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SST",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lst.mdl", ang = Angle(0, 0, 90), z = -
          2, var = "ST" },
    } },
    ...
    { ID = "!LampRP", x = 45 + 26.67 * 4, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SRP",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_rp.mdl", z = -1, ang = Angle(0, 0, 90),
        var = "RP" },
    } },
    { ID = "!LampLSN", x = 45 + 26.67 * 5, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SSN",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lsn.mdl", z = -1, ang = Angle(0, 0, 90),
        var = "SN" },
    } },
    ...
    { ID = "!LampLKVD", x = 45 + 26.67 * 6.33, y = 57.2, w = 18, h = 10, tooltip = "", model = {
      name = "SKVD",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lkvd.mdl", ang = Angle(0, 0, 90), z = -
          1, var = "KVD", },
    } },
    { ID = "!LampLKVC", x = 45 + 26.67 * 7.97, y = 57.15 - 20.0 * 2, w = 18, h = 10, tooltip = "", model = {
      name = "SKVC",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lkvc.mdl", ang = Angle(0, 0, 90), z = -
          1, var = "KVC" },
    } },
    { ID = "!LampLKT", x = 45 + 26.67 * 6.33, y = 57.9 - 20.0 * (-1), w = 18, h = 10, tooltip = "", model = {
      name = "SKT",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_lkt.mdl", z = -1, ang = Angle(0, 0, 90),
        var = "KT" },
    } },
    ...
    { ID = "!LampLEKK", x = 45 + 26.67 * 6.33, y = 57.15 - 20.0 * 2, w = 18, h = 10, tooltip = "", model = {
      name = "SLEKK",
      lamp = { speed = 10, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_gl.mdl", ang = Angle(0, 0, 90), z = -
          1, var = "GLIB" },
    } },
    { ID = "!LampLN", x = 45 + 26.67 * 6.33, y = 57.3 - 20.0 * 1, w = 18, h = 10, tooltip = "", model = {
      name = "SLN",
      lamp = { speed = 16, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_ln.mdl", z = -1, ang = Angle(0, 0, 90),
        var = "LN" },
    } },
    { ID = "!LampLRS", x = 45 + 26.67 * 7.97, y = 57.2, w = 18, h = 10, tooltip = "", model = {
      name = "SRS",
      lamp = { speed = 16, model = "models/metrostroi_train/81-717/lamps/lamps_mvm_rc.mdl", z = -1, ang = Angle(0, 0, 90),
        var = "RS" },
    } },
  }
}
ENT.ButtonMap["Block2_3"] = {
  ...
  buttons = {
    ...
    { ID = "!LOch", x = 42.5, y = 16 + 17.9 * 1, w = 35, h = 15, tooltip = "", model = {
      lamps = {
        { model = "models/metrostroi_train/81-717/lamps/oldars_l0.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR0") and not ent:GetPackedBool("AR04")) and 1 or 0 end,
          var = "AR04" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l04.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR04") and not ent:GetPackedBool("AR0")) and 1 or 0 end,
          var = "AR0" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l0_l04.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR0") and ent:GetPackedBool("AR04")) and 1 or 0 end,
          var = "AR04" },
      }
    } },
    { ID = "!LN", x = 42.5, y = 16 + 17.9 * 2, w = 35, h = 15, tooltip = "", model = {
      lamps = {
        { model = "models/metrostroi_train/81-717/lamps/oldars_ln.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("LN") and not ent:GetPackedBool("AR40")) and 1 or 0 end,
          var = "AR40" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l40.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR40") and not ent:GetPackedBool("LN")) and 1 or 0 end,
          var = "LN" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_ln_l40.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("LN") and ent:GetPackedBool("AR40")) and 1 or 0 end,
          var = "AR40" },
      }
    } },
    { ID = "!60", x = 42.5, y = 16 + 17.9 * 3, w = 35, h = 15, tooltip = "", model = {
      lamps = {
        { model = "models/metrostroi_train/81-717/lamps/oldars_l60.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR60") and not ent:GetPackedBool("AR80")) and 1 or 0 end,
          var = "AR80" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l80.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR80") and not ent:GetPackedBool("AR60")) and 1 or 0 end,
          var = "AR60" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l60_l80.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR60") and ent:GetPackedBool("AR80")) and 1 or 0 end,
          var = "AR80" },
      }
    } },
    { ID = "!70", x = 42.5, y = 16 + 17.9 * 4, w = 35, h = 15, tooltip = "", model = {
      lamps = {
        { model = "models/metrostroi_train/81-717/lamps/oldars_l70.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR70") and not ent:GetPackedBool("HRK")) and 1 or 0 end,
          var = "HRK" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_lrk.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("HRK") and not ent:GetPackedBool("AR70")) and 1 or 0 end,
          var = "AR70" },
        { model = "models/metrostroi_train/81-717/lamps/oldars_l70_lrk.mdl", z = 6, ang = 90, speed = 6,
          getfunc = function(ent) return (ent:GetPackedBool("AR70") and ent:GetPackedBool("HRK")) and 1 or 0 end,
          var = "HRK" },
      }
    } },
    ...
    { ID = "!LEKK", x = 258 + 29 * 0, y = 20 + 24 * 0, radius = 12, tooltip = "", model = {
      ...
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 75, x = -0.3, y = -0.3, z = 20.6,
        color = Color(210, 170, 255), var = "LEKK" },
    } },
    { ID = "!LPU", x = 258 + 29 * 0, y = 20 + 24 * 1, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 2, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 14, x = -0.3, y = -0.3, z = 20.6,
        color = Color(255, 130, 90), var = "LPU" },
    } },
    { ID = "!LKVD", x = 258 + 29 * 0, y = 20 + 24 * 2, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 62, x = -0.3, y = -0.3, z = 20.6,
        color = Color(255, 60, 40), var = "KVD" },
    } },
    { ID = "!LKT", x = 258 + 29 * 0, y = 20 + 24 * 3, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 2, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 105, x = -0.3, y = -0.3, z = 20.6,
        color = Color(100, 255, 100), var = "KT" },
    } },

    { ID = "!LRP", x = 258 + 29 * 1, y = 20 + 24 * 0, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 43, x = -0.3, y = -0.3, z = 20.6,
        color = Color(255, 60, 40), var = "RPR", getfunc = function(ent) return ent:GetPackedRatio("RPR") end },
    } },
    { ID = "!LKVC", x = 258 + 29 * 1, y = 20 + 24 * 1, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 1, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 4, x = -0.3, y = -0.3, z = 20.6,
        color = Color(255, 60, 40), var = "KVC" },
    } },
    { ID = "!LVD", x = 258 + 29 * 1, y = 20 + 24 * 2, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 0, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 87, x = -0.3, y = -0.3, z = 20.6,
        color = Color(100, 255, 100), var = "VD" },
    } },
    { ID = "!LST", x = 258 + 29 * 1, y = 20 + 24 * 3, radius = 12, tooltip = "", model = {
      model = "models/metrostroi_train/81-710/ezh3_slc77.mdl", skin = 4, z = -3,
      lamp = { model = "models/metrostroi_train/81-717/buttons/slc_77_lamp.mdl", ang = 32, x = -0.3, y = -0.3, z = 20.6,
        color = Color(255, 170, 110), var = "ST" },
    } },
  }
}
...
ENT.ButtonMap["Block2_1"] = {
  ...
  buttons = {
    { ID = "!Speedometer1", x = 59.5, y = 35.5, w = 12, h = 20, tooltip = "", model = {
      name = "RSpeed2", model = "models/metrostroi_train/81-717/segments/segment_mvm.mdl", color = Color(175, 250, 20),
      skin = 0, z = -2.2, ang = Angle(0, 0, -90),
    } },
    { ID = "!Speedometer2", x = 70.5, y = 35.5, w = 12, h = 20, tooltip = "", model = {
      name = "RSpeed1", model = "models/metrostroi_train/81-717/segments/segment_mvm.mdl", color = Color(175, 250, 20),
      skin = 0, z = -2.2, ang = Angle(0, 0, -90),
    } },

    { ID = "!ARSOch", x = 101.7 + 17.85 * 0, y = 52, tooltip = "", radius = 3, model = {
      name = "RAOCh",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl", color = Color(255, 56
        , 30), z = -3.5, var = "AR04" },
    } },
    ...
    { ID = "!ARS40", x = 101.75 + 17.85 * 2, y = 52, tooltip = "", radius = 3, model = {
      name = "RA40",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(255, 168, 000), z = -3.5, var = "AR40" },
    } },
    { ID = "!ARS60", x = 101.4 + 17.85 * 3, y = 52, tooltip = "", radius = 3, model = {
      name = "RA60",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "AR60" },
    } },
    { ID = "!ARS70", x = 101.5 + 17.85 * 4, y = 52, tooltip = "", radius = 3, model = {
      name = "RA70",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "AR70" },
    } },
    { ID = "!ARS80", x = 101.3 + 17.7 * 5, y = 52, tooltip = "", radius = 3, model = {
      name = "RA80",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "AR80" },
    } },

    { ID = "!LampLSD1", x = 65.4, y = 91, tooltip = "", radius = 3, model = {
      name = "RSD1",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "SD" },
    } },
    ...
    { ID = "!LampLHRK", x = 102.3, y = 91, tooltip = "", radius = 3, model = {
      name = "RRK",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(255, 168, 000), z = -3.5, var = "HRK" },
    } },
    ...
    { ID = "!LampLN", x = 215.5 - 0.4 * 1, y = 31.8 + 19.7 * 1, tooltip = "", radius = 3, model = {
      name = "RLN",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "LN" },
    } },
    ...
    { ID = "!LampLKT", x = 215.5 - 0.4 * 2, y = 31.8 + 19.7 * 3, tooltip = "", radius = 3, model = {
      name = "RKT",
      lamp = { speed = 24, model = "models/metrostroi_train/81-502/lamps/svetodiod_small_502.mdl",
        color = Color(175, 250, 20), z = -3.5, var = "KT" },
    } },
...
ENT.ButtonMap["Battery_C"] = {
  ...
  buttons = {
    ...
    { ID = "1:UOSToggle", x = 40, y = 40, radius = 40, tooltip = "", model = {
      ...
      plomb = { model = "models/metrostroi_train/81/plomb_b.mdl", ang = 0, x = 25, y = 28, var = "UOSPl", ID = "UOSPl",
        z = -15, },
      sndvol = 0.8, snd = function(val) return val and "pak_on" or "pak_off" end, sndmin = 80, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
    ...
    { ID = "1:RC1Toggle", x = 40, y = 240, radius = 40, tooltip = "", model = {
      ...
      plomb = { model = "models/metrostroi_train/81/plomb_b.mdl", ang = 230, x = -28, y = 28, var = "RC1Pl", ID = "RC1Pl",
        z = -15, },
      sndvol = 0.8, snd = function(val) return val and "pak_on" or "pak_off" end, sndmin = 80, sndmax = 1e3 / 3,
      sndang = Angle(-90, 0, 0),
    } },
...
for i=0,3 do
    ENT.ClientProps["TrainNumberL"..i] = {
        ...
        pos = Vector(280+16+i*6.6-5*6.6/2,67.4,-17.8),
        ang = Angle(0,180,0),
        skin=0,
        hide = 1.5,
        callback = function(ent)
    ...
    ENT.ClientProps["TrainNumberR"..i] = {
        model = "models/metrostroi_train/common/bort_numbers.mdl",
        pos = Vector(-295+16-i*6.6-5*6.6/2,-67.4,-17.8),
        ang = Angle(0,0,0),
        skin=0,
        hide = 1.5,
        callback = function(ent)
...
ENT.Lights = {
  ...
  -- Manometers
  [40] = { "headlight", Vector(451.9, -13.5, -2 + 5.35), Angle(52.571899 - 15 - 5, -129.269775 + 25 + 15, 49.853062),
    Color(255, 125, 25), farz = 8, nearz = 2, shadows = 1, brightness = 1, fov = 145 },
  [41] = { "headlight", Vector(451.8, -21, -2 + 5.35), Angle(52.571899 - 15 - 5, -129.269775 + 25 + 15, 49.853062),
    Color(255, 125, 25), farz = 8, nearz = 2, shadows = 1, brightness = 1, fov = 140 },
  [42] = { "headlight", Vector(450.3, 13.1, -4.4 + 5.35), Angle(-136.613632 - 33, -95.636734 - 28, 137.434570),
    Color(255, 125, 25), farz = 8, nearz = 2, shadows = 0, brightness = 1.5, fov = 120 },
  [43] = { "headlight", Vector(451.9 - 3, 3.6 + 1, 3.35 + 0.5), Angle(0, -90, 0), Color(255, 125, 25), farz = 8,
    nearz = 2, shadows = 0, brightness = 1.5, fov = 80 },
  -- Voltmeter
  [44] = { "headlight", Vector(450.273468, -32.306019, 13.236823), Angle(-18.000000, 25.541767, -90.600349),
    Color(255, 145, 25), farz = 10, nearz = 2, shadows = 1, brightness = 1, fov = 100 },
  [45] = { "headlight", Vector(450.273468, -32.306019, 18.236823), Angle(-12.000000, 25.541767, -90.600349),
    Color(255, 125, 25), farz = 10, nearz = 2, shadows = 1, brightness = 1, fov = 100 },
}
...
function ENT:UpdateWagonNumber()
	...
	self:ShowHide("TrainNumberL"..i,i<count)
        ...
        if IsValid(leftNum) then
            leftNum:SetPos(self:LocalToWorld(Vector(275+16+i*6.6-count*6.6/2,67.4,-17.8)))
            leftNum:SetSkin(num)
        end
        if IsValid(rightNum) then
            rightNum:SetPos(self:LocalToWorld(Vector(-300+16-i*6.6-count*6.6/2,-67.4,-17.8)))
...
function ENT:Think()
  ...
  if IsValid(self.ClientEnts.bell) then
	...
	self.ClientEnts.bell:SetBodygroup(3,2)
  end
  ...
  if self:GetPackedBool("LUDS") then
    if ARSType == 1 and IsValid(self.ClientEnts["SSpeed1"]) then self.ClientEnts["SSpeed1"]:SetSkin(math.floor(speed) %
      10) end
    if ARSType == 1 and IsValid(self.ClientEnts["SSpeed2"]) then self.ClientEnts["SSpeed2"]:SetSkin(math.floor(speed / 10)) end
    if (ARSType == 2 or ARSType == 3) and IsValid(self.ClientEnts["RSpeed1"]) then self.ClientEnts["RSpeed1"]:SetSkin(math
      .floor(speed) % 10) end
    if (ARSType == 2 or ARSType == 3) and IsValid(self.ClientEnts["RSpeed2"]) then self.ClientEnts["RSpeed2"]:SetSkin(math
      .floor(speed / 10)) end
  end
  ...
  self:ShowHide("k5la",hornselect ~= 14 and hornselect~=15) --show K5LA if K3L not selected
  self:ShowHide("k3la",hornselect==14 or hornselect == 15) --show K3L if K3L selected
  if (not dot5) and IsValid(self.ClientEnts.k5la) then self.ClientEnts.k5la:SetPos(self:LocalToWorld(Vector(100,0,74))) end
  if (not dot5) and IsValid(self.ClientEnts.k3la) then self.ClientEnts.k3la:SetPos(self:LocalToWorld(Vector(100,0,74))) end
  ...
  self:ShowHideSmooth("Headlights222_2", (not mask and not mask22) and HL1 or 0) -- inner headlights 222
  self:ShowHideSmooth("Headlights141_1", (mask and not mask22) and HL1 or 0) -- 141 group 1 (no ditch lights)
  self:ShowHideSmooth("Headlights141_2", (mask and not mask22) and HL2 or 0) -- 141 group 2 (no ditch lights)
  self:ShowHideSmooth("Headlights22_2", (mask22 and not mask) and HL1 or 0) -- inner headlights 22
  self:ShowHideSmooth("Headlights111", (not mask and not mask22) and HL2 or 0) -- upper left headlight
  self:ShowHideSmooth("Headlights333", (not mask) and DLDL or 0) -- Left ditch light (outer)
  self:ShowHideSmooth("Headlights444", (not mask) and DRDL or 0) -- Right ditch light (outer)
  ...
  if typ == 1 then
    for i = 1, 12 do
      ...
      self:ShowHideSmooth("lamp1_" .. i,
        self:Animate("Lamp1_" .. i, self:GetPackedBool("lightsActive" .. i) and 1 or 0, 0, 1, 6, false), col)
    end
  else
    for i = 1, 25 do
      local colV = self:GetNW2Vector("lamp" .. i)
      local col = Color(colV.x, colV.y, colV.z)
      self:ShowHideSmooth("lamp2_" .. i,
        self:Animate("Lamp2_" .. i, self:GetPackedBool("lightsActive" .. i) and 1 or 0, 0, 1, 6, false), col)
    end
  end
