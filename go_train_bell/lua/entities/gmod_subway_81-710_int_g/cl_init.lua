...
local bellselect = math.floor(math.random()+0.5) -- currently random on intermediate cars, will be selectable on cab cars
local hornselect = math.floor(math.random()+0.5) 
--------------------------------------------------------------------------------
function ENT:Think()
    ...
    self:ShowHide("k5la",hornselect==1)
    self:ShowHide("bell",bellselect==1)
    ...
    self:Animate("EmergencyBrakeValve", self:GetPackedBool("EmergencyBrakeValve") and 0 or 1,0.5,0, 7, false)
