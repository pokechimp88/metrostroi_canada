...
ENT.PrintName       = "Ezh3 (81-710) GO Transit (int)"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
...
function ENT:InitializeSounds()
    ...
    self.SoundNames["ring2"] = {loop=0.25,"subway_trains/717/ring/ringe_start.mp3","subway_trains/717/ring/ringe_loop.mp3","subway_trains/717/ring/ringe_end.mp3"}
    self.SoundPositions["ring2"] = self.SoundPositions["ring"]
    self.SoundNames["ring3"] = {loop=0.0,"subway_trains/717/ring/ringp_start.mp3","subway_trains/717/ring/ringp_loop_fast.mp3","subway_trains/717/ring/ringp_end.mp3"}
