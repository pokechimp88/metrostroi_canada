...
ENT.PrintName = "81-714.6 (Bombardier CEM Coach)"
ENT.Author          = ""
ENT.Contact         = ""
ENT.Purpose         = ""
ENT.Instructions    = ""
...
function ENT:InitializeSounds()
	...
	for i=1,8 do
		...
		self.SoundPositions["vent"..i] = {100,1e9,Vector(yventpos[i],0,30),0.1}
	end
    ...
    self.SoundPositions["crane334_brake_2"] = {375,1e9,Vector(432.27,-22.83,-8.2),0.85}
    self.SoundNames["crane334_brake_eq_high"] = {loop=true,"subway_trains/common/pneumatic/334_release_reservuar.wav"}
    self.SoundPositions["crane334_brake_eq_high"] = {350,1e9,Vector(432.27,-22.83,-70.2),0.45}
    self.SoundNames["crane334_brake_eq_low"] = {loop=true,"subway_trains/common/pneumatic/334_brake_slow2.wav"}
    self.SoundPositions["crane334_brake_eq_low"] = {350,1e9,Vector(432.27,-22.83,-70.2),0.45}
    ...
    self.SoundNames["horn"] = {loop=0.6,"subway_trains/common/pneumatic/horn/k2la_start.mp3","subway_trains/common/pneumatic/horn/k2la_loop.mp3", "subway_trains/common/pneumatic/horn/k2la_end.mp3"}
...
ENT.NumberRanges = {{4000,4250},{4500,4550}}
