...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_710_g_Electric")
...
function TRAIN_SYSTEM:SolveAllInternalCircuits(Train,dT,firstIter)
    ...
    Train:WriteTrainWire(7,BO*Train.VU2.Value)
    ...
    Panel.Headlights2 = S["F7"]
    Panel.Headlights1 = S["F7"]*Train.VU14.Value
    ...
    Panel.Ring = ARS.Ring+S["11A"]+Train.Ring.Value
