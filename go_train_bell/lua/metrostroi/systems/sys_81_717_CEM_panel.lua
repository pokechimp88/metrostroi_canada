...
--------------------------------------------------------------------------------
Metrostroi.DefineSystem("81_717_CEM_Panel")
...
function TRAIN_SYSTEM:Initialize()
    ...
    self.Train:LoadSystem("DoorBuzzer","Relay","Switch", {bass = true})
...
function TRAIN_SYSTEM:Outputs()
    return { "V1","LUDS","RedLight2","RedLight1","Headlights1","Headlights2","DitchLFlash","DitchRFlash","EqLights","CabLights","DoorBuzzer","PanelLights","CabinLight","EmergencyLights","MainLights","DoorsLeft","DoorsRight","DoorsW","GreenRP","BrW","AVU","LKVP","RZP","KUP","BrT","LSN","Ring","SD","LST","LVD","LhRK","KVC","SD","TW18", "KT",
